...
import { Group, UserInfo } from "./wavelib.js";
import { processWelcome } from "../util/wechat.js";
import { WechatRoom, WechatKeyword } from "./wechat-common.js";
...
export { WechatRoomContact };
export { WechatMessage };
export { WechatRoomWelcome };
export { WechatFile };
export { WechatMaterial };
export { WechatFriendWelcome };
export { WechatRoom };
export default {
    WechatContact,
    WechatRoomContact,
